# Bu programın amacı ,
# İstediğiniz herhangi bir postgreSQL server 'ında ki tcp ayarlarını görmenizi sağlar.
...
q1 = "SELECT name, setting, short_desc FROM pg_settings WHERE name LIKE " + "'tcp%'" + ";"
query = q1
